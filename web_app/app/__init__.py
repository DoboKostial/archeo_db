...
def create_app():
    ...
    from app.routes import main_bp, auth_bp, admin_bp, su_bp, archeo_objects_bp, polygons_bp, sections_bp, geodesy_bp, finds_samples_bp, photos_bp, photograms_bp, sketches_bp, drawings_bp
